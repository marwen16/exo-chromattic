...
public static final String TEXT_PREFERENCE = "text";
	...
	public void processRender(WebuiApplication app, WebuiRequestContext context) throws Exception {
		...
		if (PortletMode.VIEW.equals(currentMode)) {
			...
			if (getChild(UIGalleryViewerContainer.class) == null)
				addChild(UIGalleryViewerContainer.class, null, null);
		} else {
			removeChild(UIGalleryViewerContainer.class);
			if (getChild(UIGalleryViewerConfig.class) == null)
				addChild(UIGalleryViewerConfig.class, null, null);
		}
